...
class ReportSolicitudObito():
    ...
    def tabla_parrafo_tres(self, styles):
        ...
        titulo_director = Paragraph(
            u"Su; <font name='Calibri-Regular' size='10'> Óbito Fetal </font>"
            + " quien fue expulsado el día <font name='Calibri-Regular' size='10'>" + self.solicitud.fallecido_fecha_fallecimiento.strftime(
                "%d %B, %Y") + "</font> ,"
    ...
    def tabla_parrafo_cuatro(self, styles):
        ...
        titulo_director = Paragraph(
            ...
            " del Óbito Fetal, conforme a la prelación establecida en el artículo 236° del código civil;"
