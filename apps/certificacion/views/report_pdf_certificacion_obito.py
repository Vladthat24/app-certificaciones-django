...
class ReportCertificadoObito():
    ...
    def tabla_antecedentes_main(self, styles):
        ...
        titulo_presenta = Paragraph(
            ...
            + " para la cremación del cadáver de su <font name='Calibri-Bold' size='11'>"
            + self.certificado.solicitud.get_fallecido_parentesco_display() + "</font>, "
            + " expulsado el día " + self.certificado.solicitud.fallecido_fecha_fallecimiento.strftime(
                "%d de %B del %Y") + ", "
            + preposicion_titulo
            + nombre_hospital
    ...
    def tabla_fallecido(self, styles):
        ...
        print(self.tenor_solicitante)

        titulo_presenta = Paragraph(
            u"<font name='Calibri-Bold' size='11'>AUTORIZAR</font> a "
            +self.tenor_solicitante+": <font name='Calibri-Bold' size='11'>" + self.certificado.solicitud.get_solicitante() + "</font>, "
            ...
            + " con eficacia anticipada al " + self.certificado.solicitud.fecha_cremacion.strftime(
                "%d de %B del %Y") + ", "
            + " para Cremar el Cadáver de su <font name='Calibri-Bold' size='11'>" + self.certificado.solicitud.get_fallecido_parentesco_display() + "</font>, "
            + " expulsado el día " + self.certificado.solicitud.fallecido_fecha_fallecimiento.strftime(
                "%d de %B del %Y") + ", "
            + preposicion_titulo
            + nombre_hospital
            ...
            + self.certificado.solicitud.crematorio.nombre + ", ubicado en " + self.certificado.solicitud.crematorio.direccion + ".",
            sp_justifi_title_table)
