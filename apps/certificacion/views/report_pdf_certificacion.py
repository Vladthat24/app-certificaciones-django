...
class NumberedCanvas(canvas.Canvas):
    ...
    def save(self):
        ...
        for state in self._saved_page_states:
            ...
            canvas.Canvas.setFont(self, 'Times-Roman', 1, None)
...
class ReportSimulator():
    ...
    def tabla_titulo_main(self, styles):
        ...
        titulo_presenta = Paragraph(
            u"El expediente N° <font name='Calibri-Bold' size='12'>" +
            nro_expediente + "</font> , "
    ...
    def tabla_fallecido(self, styles):
        ...
        titulo_presenta = Paragraph(
            u""+self.tenor_solicitante.capitalize()+": <font name='Calibri-Bold' size='11'>" + self.certificado.solicitud.get_solicitante() + "</font>, "
    ...
    def tabla_exhorta(self, styles):
        titulo_presenta = Paragraph(
            u"<font name='Calibri-Bold' size='12'>SE EXHORTA: </font> A "+self.tenor_solicitante
    ...
    def imprimir(self):
        ...
        elements.append(Spacer(1, 0 * cm))
        elements.append(self.tabla_exhorta(styles))
...
def print_certificado_pdf(request, pk):
    ...
    if certificado.solicitud.solicitante_tipo_documento == 5:
        ...
        reporte = ReportSimulator('A4', certificado,solicitante_sexo)
